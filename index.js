...
class Repositorio {
  ...
  constructor() {
    this.pecas = JSON.parse(
      readFileSync('./pecas.json')
    );
  }
...
const faturas = JSON.parse(
  readFileSync('./faturas.json')
);

const calc =
  new ServicoCalculoFatura(
    new Repositorio()
  );
